...
{
	strcpy_s(UK_sort, "60-92-42");
	strcpy_s(UK_Account, "41001352");

}

void BACS_FORMAT::populate(char input[])
{
	string temp;
	int index, prev;
...
void printClose()
{
	cout << "\n\nProgram finished successfully.  Please review file c:\\bacs\\bconvert.dat\n\n";
